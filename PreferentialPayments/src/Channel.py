...
class Channel:
    ...
    def capacity(self, new_capacity):
        self._cln_jsn[ChannelFields.CAP] = new_capacity

    @ppm.setter
    def ppm(self, new_ppm):
        self._cln_jsn[ChannelFields.FEE_RATE] = new_ppm

    @base_fee.setter
    def base_fee(self, new_base_fee):
        self._cln_jsn[ChannelFields.BASE_FEE_MSAT] = new_base_fee
