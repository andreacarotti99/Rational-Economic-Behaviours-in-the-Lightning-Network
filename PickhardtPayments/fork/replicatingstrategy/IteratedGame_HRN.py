...
simulation.run_success_payments_simulation(payments_to_simulate, payments_amount, mu, base, distribution, dist_func, verbose)
...
filename = "results_HRN_" + "sats" + str(payments_amount) + "_" + "numpayments" + str(payments_to_simulate) + "_" + "mu" + str(mu) + "_" \
           "dist" + str(distribution[0:4]) + "_" +"tentnodes" + str(tentative_nodes_to_keep) + "_closing" + closing_strategy + ".csv"
