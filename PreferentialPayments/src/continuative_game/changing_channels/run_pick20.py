...
from src.continuative_game.changing_channels.infinite_simulation_channels_pick20 import run_infinite_simulation
...
def main():
    ...
    print_params()
    db_name = f'channels_alfa{alfa}_{distribution[0:4]}_20.db'
