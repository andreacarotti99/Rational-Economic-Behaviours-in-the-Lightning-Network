...
filename = "results_convexBC_" + "sats" + str(payments_amount) + "_" + "numpayments" + str(payments_to_simulate) + "_" + "mu" + str(mu) + "_" \
           "dist" + str(distribution[0:4]) + "_" + "gamma" + str(gamma) + "_" +"tentnodes" + str(tentative_nodes_to_keep) + ".csv"
